...
library PriceConverter {
  ...
  function getConvertedRate(uint256 ethAmount, AggregatorV3Interface priceFeed) public view returns(uint256){
    uint256 priceOfEth = getPrice(priceFeed);
    return (priceOfEth * ethAmount) / 1e18;
  }

  function getDecimals(AggregatorV3Interface priceFeed) public view returns(uint8){
